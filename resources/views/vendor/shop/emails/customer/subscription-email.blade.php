@component('shop::emails.layouts.master')
    ...
    @php
        $shopName = \Company::getCurrent()->name;
    @endphp
    ...
    <div>
        ...
        <div  style="font-size:16px; color:#242424; font-weight:600; margin-top: 60px; margin-bottom: 15px">
            {!! __('shop::app.mail.customer.subscription.greeting', ['shop_name' => $shopName]) !!}
        </div>

        <div>
            {!! __('shop::app.mail.customer.subscription.summary', ['shop_name' => $shopName]) !!}
        </div>
