...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <link rel="icon" sizes="16x16" href="{{ asset('vendor/webkul/custom/assets/images/favicon.ico') }}" />
            ...
            <div class="center-box">
                ...
                <div class="adjacent-center">
                    ...
                    <div class="brand-logo">
                        ...
                        @else
                            <img src="{{ asset('vendor/webkul/custom/assets/images/razzo.png') }}" alt="Bagisto"/>
                        @endif
                    </div>
