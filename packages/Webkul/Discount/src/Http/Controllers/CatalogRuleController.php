...
class CatalogRuleController extends Controller
{
    ...
    {
        return view($this->_config['view'])->with('catalog_rule', ['config' => $this->appliedConfig, 'categories' => $this->category->getPartial(), 'attribute_family' => $this->attributeFamily->getPartial()]);
    }
